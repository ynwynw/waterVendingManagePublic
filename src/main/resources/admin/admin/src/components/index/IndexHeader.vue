<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block","margin-right":"auto"}'>
			<el-image v-if="false" class="title-img" :style='{"width":"34px","objectFit":"cover","borderRadius":"100%","float":"left","height":"34px"}' src="http://localhost:8080/waterVendingManage/upload/7856ba26477849ea828f481fa2773a95.jpg" fit="cover" />
